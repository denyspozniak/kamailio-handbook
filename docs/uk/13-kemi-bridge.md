...
- **Python** — falsy лише `0`, `None`, порожні контейнери. `-1` — **truthy**. Та сама пастка.
- **JavaScript** — `0` falsy, будь-яке інше число, включно з `-1`, — truthy.
