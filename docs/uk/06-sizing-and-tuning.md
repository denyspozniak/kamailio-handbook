...
**Що домінує в ціні.**
- Розмір shm — `usrloc`-кеш масштабується лінійно з онлайн-контактами. Груба евристика: ~500 B на контакт.
...
2. **Налийте реалістичне навантаження.** Беріть [SIPp](https://github.com/SIPp/sipp) або capture-replay з продакшну. Синтетичні патерни вводять в оману.
