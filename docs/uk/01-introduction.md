...
> [!TIP]
> Перш ніж рухатися далі, пройдіть [1.2 Швидкий старт](02-getting-started.md) — встановіть Kamailio та запустіть тривіальний конфіг. Архітектурні розділи передбачають, що ви вмієте підняти Kamailio й побачити, як SIP-повідомлення в нього прилітає.

---

<p align="center">
  <a href="README.md">← Зміст</a> · <a href="02-getting-started.md">Далі: 1.2 Швидкий старт →</a>
</p>
