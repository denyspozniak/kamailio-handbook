...
Суть діаграми — у пунктирній лінії: ворожий пакет їде *тим самим* пайплайном, що й хороший, а найраніша точка відхилення все одно нижче за течією від парсингу — усередині `request_route`, після того як `sanity` уже відпрацював. Усе до `drop` — це робота, яку ви зробили на користь атакувальника.
